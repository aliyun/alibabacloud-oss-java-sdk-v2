...
public class DeleteAgenticBucketPublicAccessBlockAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncAgenticBucketClient client = clientBuilder.build()) {
            DeleteAgenticBucketPublicAccessBlockResult result = client.deleteAgenticBucketPublicAccessBlockAsync(DeleteAgenticBucketPublicAccessBlockRequest.newBuilder()
                    .bucket(bucket)
                    .build()).get();
