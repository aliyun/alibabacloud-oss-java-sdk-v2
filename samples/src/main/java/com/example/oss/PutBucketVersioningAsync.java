...
public class PutBucketVersioningAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncClient client = getDefaultAsyncClient(endpoint, region, provider)) {
            ...
            PutBucketVersioningResult result = client.putBucketVersioningAsync(PutBucketVersioningRequest.newBuilder()
                            .bucket(bucket)
