...
public class PutBucketArchiveDirectReadAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncClient client = getDefaultAsyncClient(endpoint, region, provider)) {
            ...
            PutBucketArchiveDirectReadResult result = client.putBucketArchiveDirectReadAsync(PutBucketArchiveDirectReadRequest.newBuilder()
                            .bucket(bucket)
    ...
    public Options getOptions() {
        ...
        opts.addOption(Option.builder().longOpt("enabled").desc("Whether to enable archive direct read. Valid values: true, false.").hasArg().required().get());
        return opts;
    }
