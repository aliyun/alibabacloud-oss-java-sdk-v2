...
public class GetBucketReplicationProgressAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncClient client = getDefaultAsyncClient(endpoint, region, provider)) {
            ...
            GetBucketReplicationProgressResult result = client.getBucketReplicationProgressAsync(GetBucketReplicationProgressRequest.newBuilder()
                            .bucket(bucket)
                            .ruleId(ruleId)
                            .build()).get();
