...
public class GetVectorsAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncVectorsClient client = clientBuilder.build()) {
            ...
            CompletableFuture<GetVectorsResult> future = client.getVectorsAsync(requestBuilder.build());

            GetVectorsResult result = future.get();
