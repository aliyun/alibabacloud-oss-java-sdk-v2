...
public class PutVectorIndexAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncVectorsClient client = clientBuilder.build()) {
            ...
            CompletableFuture<PutVectorIndexResult> future = client.putVectorIndexAsync(request);

            PutVectorIndexResult result = future.get();
