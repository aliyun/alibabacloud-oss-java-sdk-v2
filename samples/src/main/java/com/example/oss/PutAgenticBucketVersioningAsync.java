...
public class PutAgenticBucketVersioningAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncAgenticBucketClient client = clientBuilder.build()) {
            PutAgenticBucketVersioningResult result = client.putAgenticBucketVersioningAsync(PutAgenticBucketVersioningRequest.newBuilder()
                    .bucket(bucket)
    ...
    public Options getOptions() {
        ...
        opts.addOption(Option.builder().longOpt("status").desc("The versioning state of the agentic bucket, e.g. Enabled, Suspended.").hasArg().required().get());
        return opts;
    }
    ...
    public void runCmd(CommandLine cmd) throws ParseException {
        ...
        execute(endpoint, region, accountId, bucket, status);
    }
}
