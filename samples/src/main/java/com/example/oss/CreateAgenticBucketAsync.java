...
public class CreateAgenticBucketAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncAgenticBucketClient client = clientBuilder.build()) {
            CreateAgenticBucketResult result = client.createAgenticBucketAsync(CreateAgenticBucketRequest.newBuilder()
                    .bucket(bucket)
