...
public class GetAccessPointPolicyForObjectProcess implements Example {
    ...
    private static void execute(
        ...
        try (OSSClient client = getDefaultClient(endpoint, region, provider)) {
            ...
            GetAccessPointPolicyForObjectProcessResult result = client.getAccessPointPolicyForObjectProcess(request);

            System.out.printf("Get access point policy for object process success, request id: %s\n",
                    result.requestId());
