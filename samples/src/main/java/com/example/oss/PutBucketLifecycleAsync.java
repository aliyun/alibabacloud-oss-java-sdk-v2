...
public class PutBucketLifecycleAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncClient client = getDefaultAsyncClient(endpoint, region, provider)) {
            ...
            // Build lifecycle rule - expiration deletion
            ...
            PutBucketLifecycleResult result = client.putBucketLifecycleAsync(PutBucketLifecycleRequest.newBuilder()
                            .bucket(bucket)
