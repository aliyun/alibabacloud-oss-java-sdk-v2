...
public class PutAgenticBucketPublicAccessBlockAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncAgenticBucketClient client = clientBuilder.build()) {
            PutAgenticBucketPublicAccessBlockResult result = client.putAgenticBucketPublicAccessBlockAsync(PutAgenticBucketPublicAccessBlockRequest.newBuilder()
                    .bucket(bucket)
