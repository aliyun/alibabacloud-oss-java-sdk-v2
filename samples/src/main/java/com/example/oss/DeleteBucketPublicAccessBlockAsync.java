...
public class DeleteBucketPublicAccessBlockAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncClient client = getDefaultAsyncClient(endpoint, region, provider)) {
            ...
            DeleteBucketPublicAccessBlockResult result = client.deleteBucketPublicAccessBlockAsync(DeleteBucketPublicAccessBlockRequest.newBuilder()
                            .bucket(bucket)
                            .build()).get();
