...
public class PutAgenticBucketPolicyAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncAgenticBucketClient client = clientBuilder.build()) {
            ...
            PutAgenticBucketPolicyResult result = client.putAgenticBucketPolicyAsync(PutAgenticBucketPolicyRequest.newBuilder()
                    .bucket(bucket)
                    .policy(policy)
                    .build()).get();
