...
public class DeleteAccessPointPolicy implements Example {
    ...
    private static void execute(
        ...
        try (OSSClient client = getDefaultClient(endpoint, region, provider)) {
            ...
            DeleteAccessPointPolicyResult result = client.deleteAccessPointPolicy(request);

            System.out.printf("Delete access point policy success, request id: %s\n",
                    result.requestId());
