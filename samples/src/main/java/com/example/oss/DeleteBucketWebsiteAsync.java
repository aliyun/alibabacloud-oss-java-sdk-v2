...
public class DeleteBucketWebsiteAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncClient client = getDefaultAsyncClient(endpoint, region, provider)) {
            ...
            DeleteBucketWebsiteResult result = client.deleteBucketWebsiteAsync(DeleteBucketWebsiteRequest.newBuilder()
                            .bucket(bucket)
                            .build()).get();
