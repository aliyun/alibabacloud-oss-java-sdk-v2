...
public class GetBucketInventoryAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncClient client = getDefaultAsyncClient(endpoint, region, provider)) {
            ...
            CompletableFuture<GetBucketInventoryResult> future = client.getBucketInventoryAsync(request);
            GetBucketInventoryResult result = future.get();
