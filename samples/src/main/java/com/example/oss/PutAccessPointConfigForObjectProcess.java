...
public class PutAccessPointConfigForObjectProcess implements Example {
    ...
    private static void execute(
        ...
        try (OSSClient client = getDefaultClient(endpoint, region, provider)) {
            ...
            PutAccessPointConfigForObjectProcessResult result = client.putAccessPointConfigForObjectProcess(request);

            System.out.printf("Put access point config for object process success, request id: %s\n", result.requestId());
