...
public class PutAgenticBucketVersioning implements Example {
    ...
    private static void execute(
        ...
        try (OSSAgenticBucketClient client = clientBuilder.build()) {
            PutAgenticBucketVersioningResult result = client.putAgenticBucketVersioning(PutAgenticBucketVersioningRequest.newBuilder()
                    .bucket(bucket)
