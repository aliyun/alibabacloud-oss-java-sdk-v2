...
public class DeleteBucketLoggingAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncClient client = getDefaultAsyncClient(endpoint, region, provider)) {
            ...
            DeleteBucketLoggingResult result = client.deleteBucketLoggingAsync(DeleteBucketLoggingRequest.newBuilder()
                            .bucket(bucket)
                            .build()).get();
