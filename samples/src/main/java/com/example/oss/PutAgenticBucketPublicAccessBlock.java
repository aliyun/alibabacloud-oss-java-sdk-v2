...
public class PutAgenticBucketPublicAccessBlock implements Example {
    ...
    private static void execute(
        ...
        try (OSSAgenticBucketClient client = clientBuilder.build()) {
            PutAgenticBucketPublicAccessBlockResult result = client.putAgenticBucketPublicAccessBlock(PutAgenticBucketPublicAccessBlockRequest.newBuilder()
                    .bucket(bucket)
