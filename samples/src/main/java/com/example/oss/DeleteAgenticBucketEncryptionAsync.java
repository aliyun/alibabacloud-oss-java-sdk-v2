...
public class DeleteAgenticBucketEncryptionAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncAgenticBucketClient client = clientBuilder.build()) {
            DeleteAgenticBucketEncryptionResult result = client.deleteAgenticBucketEncryptionAsync(DeleteAgenticBucketEncryptionRequest.newBuilder()
                    .bucket(bucket)
                    .build()).get();
