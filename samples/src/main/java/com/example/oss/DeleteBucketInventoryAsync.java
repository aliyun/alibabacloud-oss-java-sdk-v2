...
public class DeleteBucketInventoryAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncClient client = getDefaultAsyncClient(endpoint, region, provider)) {
            ...
            CompletableFuture<DeleteBucketInventoryResult> future = client.deleteBucketInventoryAsync(request);
            DeleteBucketInventoryResult result = future.get();
    ...
    public Options getOptions() {
        ...
        opts.addOption(Option.builder().longOpt("inventoryId").desc("The inventory configuration ID to delete.").hasArg().required().get());
        return opts;
    }
