...
public class CreateAccessPointForObjectProcessAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncClient client = getDefaultAsyncClient(endpoint, region, provider)) {
            ...
            CompletableFuture<CreateAccessPointForObjectProcessResult> future = client.createAccessPointForObjectProcessAsync(request);

            CreateAccessPointForObjectProcessResult result = future.get();

            System.out.printf("Create access point for object process success, status code: %d\n",
                    result.statusCode());
    ...
    public void runCmd(CommandLine cmd) throws ParseException {
        ...
        String allowAnonymousAccessForObjectProcess = cmd.getOptionValue("allowAnonymousAccessForObjectProcess");
