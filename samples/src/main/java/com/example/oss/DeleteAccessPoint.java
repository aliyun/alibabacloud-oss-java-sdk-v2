...
public class DeleteAccessPoint implements Example {
    ...
    private static void execute(
        ...
        try (OSSClient client = getDefaultClient(endpoint, region, provider)) {
            ...
            DeleteAccessPointResult result = client.deleteAccessPoint(request);

            System.out.printf("Delete access point success, request id: %s\n",
                    result.requestId());
