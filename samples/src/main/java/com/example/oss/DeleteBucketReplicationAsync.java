...
public class DeleteBucketReplicationAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncClient client = getDefaultAsyncClient(endpoint, region, provider)) {
            ...
            DeleteBucketReplicationResult result = client.deleteBucketReplicationAsync(DeleteBucketReplicationRequest.newBuilder()
                            .bucket(bucket)
    ...
    public Options getOptions() {
        ...
        opts.addOption(Option.builder().longOpt("ruleId").desc("The ID of the replication rule to delete.").hasArg().required().get());
        return opts;
    }
