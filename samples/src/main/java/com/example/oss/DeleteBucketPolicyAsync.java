...
public class DeleteBucketPolicyAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncClient client = getDefaultAsyncClient(endpoint, region, provider)) {
            ...
            DeleteBucketPolicyResult result = client.deleteBucketPolicyAsync(DeleteBucketPolicyRequest.newBuilder()
                            .bucket(bucket)
                            .build()).get();
