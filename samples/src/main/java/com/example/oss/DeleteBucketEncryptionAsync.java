...
public class DeleteBucketEncryptionAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncClient client = getDefaultAsyncClient(endpoint, region, provider)) {
            ...
            DeleteBucketEncryptionResult result = client.deleteBucketEncryptionAsync(DeleteBucketEncryptionRequest.newBuilder()
                            .bucket(bucket)
                            .build()).get();
