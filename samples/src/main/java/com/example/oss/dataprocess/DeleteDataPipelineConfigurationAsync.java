...
public class DeleteDataPipelineConfigurationAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSDataProcessAsyncClient client = clientBuilder.build()) {
            ...
            DeleteDataPipelineConfigurationResult result = client.deleteDataPipelineConfigurationAsync(
