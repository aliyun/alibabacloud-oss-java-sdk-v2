...
public class SimpleQueryAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSDataProcessAsyncClient client = clientBuilder.build()) {
            ...
            com.aliyun.sdk.service.oss2.dataprocess.models.SimpleQuery query =
                    com.aliyun.sdk.service.oss2.dataprocess.models.SimpleQuery.newBuilder()
                            .field("Size")
                            .value("0")
                            .operation("gt")
                            .build();
