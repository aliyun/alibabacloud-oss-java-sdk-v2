...
public class DeleteFileMetaAsync implements Example {
    ...
    public Options getOptions() {
        ...
        opts.addOption(Option.builder().longOpt("uri").desc("The URI of the file to delete meta for.").hasArg().required().get());
        return opts;
    }
    ...
    public void runCmd(CommandLine cmd) throws ParseException {
        ...
        String uri = cmd.getParsedOptionValue("uri");
        execute(endpoint, region, bucket, datasetName, uri);
    }
}
