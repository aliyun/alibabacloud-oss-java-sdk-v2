...
public class GetBucketAccessMonitorAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncClient client = getDefaultAsyncClient(endpoint, region, provider)) {
            ...
            GetBucketAccessMonitorResult result = client.getBucketAccessMonitorAsync(GetBucketAccessMonitorRequest.newBuilder()
                            .bucket(bucket)
                            .build()).get();
            ...
            System.out.printf("AllowCopy: %s\n", result.accessMonitorConfiguration().allowCopy());
