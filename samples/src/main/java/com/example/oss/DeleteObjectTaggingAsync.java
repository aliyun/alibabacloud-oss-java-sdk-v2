...
public class DeleteObjectTaggingAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncClient client = getDefaultAsyncClient(endpoint, region, provider)) {
            ...
            DeleteObjectTaggingRequest.Builder requestBuilder = DeleteObjectTaggingRequest.newBuilder()
                    .bucket(bucket)
                    .key(key);
            ...
            DeleteObjectTaggingResult result = client.deleteObjectTaggingAsync(requestBuilder.build()).get();
    ...
    public Options getOptions() {
        ...
        opts.addOption(Option.builder().longOpt("versionId").desc("The version ID of the object that you want to delete.").hasArg().get());
        return opts;
    }
