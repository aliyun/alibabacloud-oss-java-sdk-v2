...
import com.aliyun.sdk.service.oss2.tables.models.DeleteTablePolicyRequest;
import com.aliyun.sdk.service.oss2.tables.models.DeleteTablePolicyResult;
...
public class DeleteTablePolicySampleAsync implements com.example.oss.Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncTablesClient client = clientBuilder.build()) {
            ...
            CompletableFuture<DeleteTablePolicyResult> future = client.deleteTablePolicyAsync(request);
