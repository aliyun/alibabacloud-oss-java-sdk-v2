...
import com.aliyun.sdk.service.oss2.tables.models.PutTablePolicyRequest;
import com.aliyun.sdk.service.oss2.tables.models.PutTablePolicyResult;
...
public class PutTablePolicySampleAsync implements com.example.oss.Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncTablesClient client = clientBuilder.build()) {
            ...
            CompletableFuture<PutTablePolicyResult> future = client.putTablePolicyAsync(request);
    ...
    public Options getOptions() {
        ...
        opts.addOption(Option.builder().longOpt("resourcePolicy").desc("The resource policy to set on the table.").hasArg().required().get());
        return opts;
    }
    ...
    public void runCmd(CommandLine cmd) throws ParseException {
        ...
        execute(endpoint, region, tableBucketARN, namespace, name, resourcePolicy);
    }
}
