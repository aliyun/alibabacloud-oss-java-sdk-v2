...
public class PutTableBucketEncryptionSampleAsync implements com.example.oss.Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncTablesClient client = clientBuilder.build()) {
            ...
            CompletableFuture<PutTableBucketEncryptionResult> future = client.putTableBucketEncryptionAsync(request);
