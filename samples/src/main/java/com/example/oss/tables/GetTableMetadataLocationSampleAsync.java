...
import com.aliyun.sdk.service.oss2.tables.models.GetTableMetadataLocationRequest;
import com.aliyun.sdk.service.oss2.tables.models.GetTableMetadataLocationResult;
...
public class GetTableMetadataLocationSampleAsync implements com.example.oss.Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncTablesClient client = clientBuilder.build()) {
            ...
            CompletableFuture<GetTableMetadataLocationResult> future = client.getTableMetadataLocationAsync(request);
