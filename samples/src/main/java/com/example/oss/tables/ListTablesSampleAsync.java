...
public class ListTablesSampleAsync implements com.example.oss.Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncTablesClient client = clientBuilder.build()) {
            ...
            CompletableFuture<ListTablesResult> future = client.listTablesAsync(requestBuilder.build());
