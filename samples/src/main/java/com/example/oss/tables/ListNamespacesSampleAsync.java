...
public class ListNamespacesSampleAsync implements com.example.oss.Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncTablesClient client = clientBuilder.build()) {
            ...
            CompletableFuture<ListNamespacesResult> future = client.listNamespacesAsync(request);
