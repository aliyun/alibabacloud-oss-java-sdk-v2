...
import com.aliyun.sdk.service.oss2.tables.models.PutTableBucketPolicyRequest;
import com.aliyun.sdk.service.oss2.tables.models.PutTableBucketPolicyResult;
...
public class PutTableBucketPolicySampleAsync implements com.example.oss.Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncTablesClient client = clientBuilder.build()) {
            ...
            CompletableFuture<PutTableBucketPolicyResult> future = client.putTableBucketPolicyAsync(request);
    ...
    public Options getOptions() {
        ...
        opts.addOption(Option.builder().longOpt("tableBucketARN").desc("The ARN of the table bucket to update policy for.").hasArg().required().get());
        opts.addOption(Option.builder().longOpt("resourcePolicy").desc("The resource policy to set on the table bucket.").hasArg().required().get());
        return opts;
    }
    ...
    public void runCmd(CommandLine cmd) throws ParseException {
        ...
        String resourcePolicy = cmd.getParsedOptionValue("resourcePolicy");
        execute(endpoint, region, tableBucketARN, resourcePolicy);
    }
}