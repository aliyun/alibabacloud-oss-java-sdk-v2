...
import com.aliyun.sdk.service.oss2.tables.models.GetTablePolicyRequest;
import com.aliyun.sdk.service.oss2.tables.models.GetTablePolicyResult;
...
public class GetTablePolicySampleAsync implements com.example.oss.Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncTablesClient client = clientBuilder.build()) {
            ...
            CompletableFuture<GetTablePolicyResult> future = client.getTablePolicyAsync(request);
