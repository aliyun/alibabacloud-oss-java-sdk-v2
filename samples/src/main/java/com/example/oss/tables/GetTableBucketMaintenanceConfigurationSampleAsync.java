...
public class GetTableBucketMaintenanceConfigurationSampleAsync implements com.example.oss.Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncTablesClient client = clientBuilder.build()) {
            ...
            CompletableFuture<GetTableBucketMaintenanceConfigurationResult> future = client.getTableBucketMaintenanceConfigurationAsync(request);
