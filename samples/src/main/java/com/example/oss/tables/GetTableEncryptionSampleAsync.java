...
public class GetTableEncryptionSampleAsync implements com.example.oss.Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncTablesClient client = clientBuilder.build()) {
            ...
            CompletableFuture<GetTableEncryptionResult> future = client.getTableEncryptionAsync(request);
