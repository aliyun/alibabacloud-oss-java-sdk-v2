...
public class CreateNamespaceSampleAsync implements com.example.oss.Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncTablesClient client = clientBuilder.build()) {
            ...
            CompletableFuture<CreateNamespaceResult> future = client.createNamespaceAsync(request);
