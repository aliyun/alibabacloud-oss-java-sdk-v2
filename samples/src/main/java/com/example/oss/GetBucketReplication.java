...
public class GetBucketReplication implements Example {
    ...
    private static void execute(
        ...
        try (OSSClient client = clientBuilder.build()) {
            ...
            GetBucketReplicationResult result = client.getBucketReplication(GetBucketReplicationRequest.newBuilder()
                            .bucket(bucket)
                            .build());
