...
public class GetAccessPointForObjectProcessAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncClient client = getDefaultAsyncClient(endpoint, region, provider)) {
            ...
            CompletableFuture<GetAccessPointForObjectProcessResult> future = client.getAccessPointForObjectProcessAsync(request);
