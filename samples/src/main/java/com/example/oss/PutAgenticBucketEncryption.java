...
public class PutAgenticBucketEncryption implements Example {
    ...
    private static void execute(
        ...
        try (OSSAgenticBucketClient client = clientBuilder.build()) {
            PutAgenticBucketEncryptionResult result = client.putAgenticBucketEncryption(PutAgenticBucketEncryptionRequest.newBuilder()
                    .bucket(bucket)
