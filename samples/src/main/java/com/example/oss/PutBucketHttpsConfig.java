...
public class PutBucketHttpsConfig implements Example {
    ...
    private static void execute(
        ...
        try (OSSClient client = clientBuilder.build()) {
            ...
            PutBucketHttpsConfigResult result = client.putBucketHttpsConfig(PutBucketHttpsConfigRequest.newBuilder()
                            .bucket(bucket)
