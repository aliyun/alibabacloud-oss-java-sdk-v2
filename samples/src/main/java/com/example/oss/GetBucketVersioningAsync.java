...
public class GetBucketVersioningAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncClient client = getDefaultAsyncClient(endpoint, region, provider)) {
            ...
            GetBucketVersioningResult result = client.getBucketVersioningAsync(GetBucketVersioningRequest.newBuilder()
                            .bucket(bucket)
                            .build()).get();
