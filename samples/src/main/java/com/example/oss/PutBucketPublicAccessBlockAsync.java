...
public class PutBucketPublicAccessBlockAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncClient client = getDefaultAsyncClient(endpoint, region, provider)) {
            ...
            PutBucketPublicAccessBlockResult result = client.putBucketPublicAccessBlockAsync(PutBucketPublicAccessBlockRequest.newBuilder()
                            .bucket(bucket)
