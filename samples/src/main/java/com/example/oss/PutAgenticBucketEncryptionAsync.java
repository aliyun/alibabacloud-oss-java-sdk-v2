...
public class PutAgenticBucketEncryptionAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncAgenticBucketClient client = clientBuilder.build()) {
            PutAgenticBucketEncryptionResult result = client.putAgenticBucketEncryptionAsync(PutAgenticBucketEncryptionRequest.newBuilder()
                    .bucket(bucket)
                    .serverSideEncryptionRule(ServerSideEncryptionRule.newBuilder()
                            .applyServerSideEncryptionByDefault(ApplyServerSideEncryptionByDefault.newBuilder()
                                    .sseAlgorithm("AES256")
                                    .build())
                            .build())
                    .build()).get();
