...
public class GetAgenticBucketPolicyAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncAgenticBucketClient client = clientBuilder.build()) {
            GetAgenticBucketPolicyResult result = client.getAgenticBucketPolicyAsync(GetAgenticBucketPolicyRequest.newBuilder()
                    .bucket(bucket)
                    .build()).get();
