...
public class PutUserDefinedLogFieldsConfigAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncClient client = getDefaultAsyncClient(endpoint, region, provider)) {
            ...
            PutUserDefinedLogFieldsConfigResult result = client.putUserDefinedLogFieldsConfigAsync(
