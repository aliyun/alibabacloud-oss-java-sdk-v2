...
public class GetBucketDataRedundancyTransitionAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncClient client = getDefaultAsyncClient(endpoint, region, provider)) {
            ...
            GetBucketDataRedundancyTransitionResult result = client.getBucketDataRedundancyTransitionAsync(
