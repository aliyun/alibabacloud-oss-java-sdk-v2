...
public class GetAgenticBucketVersioning implements Example {
    ...
    private static void execute(
        ...
        try (OSSAgenticBucketClient client = clientBuilder.build()) {
            GetAgenticBucketVersioningResult result = client.getAgenticBucketVersioning(GetAgenticBucketVersioningRequest.newBuilder()
                    .bucket(bucket)
                    .build());
