...
public class PutPublicAccessBlockAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncClient client = OSSAsyncClient.newBuilder()
            ...
            PutPublicAccessBlockResult result = client.putPublicAccessBlockAsync(PutPublicAccessBlockRequest.newBuilder()
