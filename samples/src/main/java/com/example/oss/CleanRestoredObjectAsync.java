...
public class CleanRestoredObjectAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncClient client = getDefaultAsyncClient(endpoint, region, provider)) {
            ...
            CleanRestoredObjectResult result = client.cleanRestoredObjectAsync(CleanRestoredObjectRequest.newBuilder()
                            .bucket(bucket)
                            .key(key)
                    .build()).get();
