...
public class GetAgenticBucketPublicAccessBlock implements Example {
    ...
    private static void execute(
        ...
        try (OSSAgenticBucketClient client = clientBuilder.build()) {
            GetAgenticBucketPublicAccessBlockResult result = client.getAgenticBucketPublicAccessBlock(GetAgenticBucketPublicAccessBlockRequest.newBuilder()
                    .bucket(bucket)
                    .build());
