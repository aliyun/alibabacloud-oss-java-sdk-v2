...
public class PutAgenticBucketAclAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncAgenticBucketClient client = clientBuilder.build()) {
            PutAgenticBucketAclResult result = client.putAgenticBucketAclAsync(PutAgenticBucketAclRequest.newBuilder()
                    .bucket(bucket)
                    .acl(acl)
                    .build()).get();
