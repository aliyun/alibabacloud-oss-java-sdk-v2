...
public class ListBucketDataRedundancyTransitionAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncClient client = getDefaultAsyncClient(endpoint, region, provider)) {
            ...
            ListBucketDataRedundancyTransitionResult result = client.listBucketDataRedundancyTransitionAsync(
