...
public class CreateBucketDataRedundancyTransition implements Example {
    ...
    private static void execute(
        ...
        try (OSSClient client = clientBuilder.build()) {
            ...
            CreateBucketDataRedundancyTransitionResult result = client.createBucketDataRedundancyTransition(
