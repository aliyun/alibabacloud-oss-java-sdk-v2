...
public class DeleteBucketDataRedundancyTransition implements Example {
    ...
    private static void execute(
        ...
        try (OSSClient client = clientBuilder.build()) {
            ...
            DeleteBucketDataRedundancyTransitionResult result = client.deleteBucketDataRedundancyTransition(
