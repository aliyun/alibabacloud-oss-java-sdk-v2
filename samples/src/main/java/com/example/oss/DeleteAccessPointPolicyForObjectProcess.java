...
public class DeleteAccessPointPolicyForObjectProcess implements Example {
    ...
    private static void execute(
        ...
        try (OSSClient client = getDefaultClient(endpoint, region, provider)) {
            ...
            DeleteAccessPointPolicyForObjectProcessResult result = client.deleteAccessPointPolicyForObjectProcess(request);

            System.out.printf("Delete access point policy for object process success, request id: %s\n",
                    result.requestId());
