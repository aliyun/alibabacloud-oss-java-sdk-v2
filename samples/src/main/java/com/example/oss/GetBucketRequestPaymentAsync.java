...
public class GetBucketRequestPaymentAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncClient client = getDefaultAsyncClient(endpoint, region, provider)) {
            ...
            GetBucketRequestPaymentResult result = client.getBucketRequestPaymentAsync(GetBucketRequestPaymentRequest.newBuilder()
                            .bucket(bucket)
                            .build()).get();
