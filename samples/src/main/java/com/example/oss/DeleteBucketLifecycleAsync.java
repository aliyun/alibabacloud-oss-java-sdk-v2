...
public class DeleteBucketLifecycleAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncClient client = getDefaultAsyncClient(endpoint, region, provider)) {
            ...
            DeleteBucketLifecycleResult result = client.deleteBucketLifecycleAsync(DeleteBucketLifecycleRequest.newBuilder()
                            .bucket(bucket)
                            .build()).get();
