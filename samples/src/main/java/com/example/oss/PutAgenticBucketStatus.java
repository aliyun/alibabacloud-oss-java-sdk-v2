...
public class PutAgenticBucketStatus implements Example {
    ...
    private static void execute(
        ...
        try (OSSAgenticBucketClient client = clientBuilder.build()) {
            PutAgenticBucketStatusResult result = client.putAgenticBucketStatus(PutAgenticBucketStatusRequest.newBuilder()
                    .bucket(bucket)
