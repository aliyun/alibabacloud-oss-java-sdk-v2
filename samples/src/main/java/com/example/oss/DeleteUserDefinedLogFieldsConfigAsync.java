...
public class DeleteUserDefinedLogFieldsConfigAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncClient client = getDefaultAsyncClient(endpoint, region, provider)) {
            ...
            DeleteUserDefinedLogFieldsConfigResult result = client.deleteUserDefinedLogFieldsConfigAsync(
