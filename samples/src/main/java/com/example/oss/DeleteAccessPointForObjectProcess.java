...
public class DeleteAccessPointForObjectProcess implements Example {
    ...
    private static void execute(
        ...
        try (OSSClient client = getDefaultClient(endpoint, region, provider)) {
            ...
            DeleteAccessPointForObjectProcessResult result = client.deleteAccessPointForObjectProcess(request);
