...
public class DeleteAgenticBucketPublicAccessBlock implements Example {
    ...
    private static void execute(
        ...
        try (OSSAgenticBucketClient client = clientBuilder.build()) {
            DeleteAgenticBucketPublicAccessBlockResult result = client.deleteAgenticBucketPublicAccessBlock(DeleteAgenticBucketPublicAccessBlockRequest.newBuilder()
                    .bucket(bucket)
                    .build());
