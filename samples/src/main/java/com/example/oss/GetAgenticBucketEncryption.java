...
public class GetAgenticBucketEncryption implements Example {
    ...
    private static void execute(
        ...
        try (OSSAgenticBucketClient client = clientBuilder.build()) {
            GetAgenticBucketEncryptionResult result = client.getAgenticBucketEncryption(GetAgenticBucketEncryptionRequest.newBuilder()
                    .bucket(bucket)
                    .build());
