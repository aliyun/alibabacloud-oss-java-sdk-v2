...
public class GetAgenticBucketPolicy implements Example {
    ...
    private static void execute(
        ...
        try (OSSAgenticBucketClient client = clientBuilder.build()) {
            GetAgenticBucketPolicyResult result = client.getAgenticBucketPolicy(GetAgenticBucketPolicyRequest.newBuilder()
                    .bucket(bucket)
                    .build());
