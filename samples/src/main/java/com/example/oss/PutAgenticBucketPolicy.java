...
public class PutAgenticBucketPolicy implements Example {
    ...
    private static void execute(
        ...
        try (OSSAgenticBucketClient client = clientBuilder.build()) {
            ...
            PutAgenticBucketPolicyResult result = client.putAgenticBucketPolicy(PutAgenticBucketPolicyRequest.newBuilder()
                    .bucket(bucket)
                    .policy(policy)
                    .build());
