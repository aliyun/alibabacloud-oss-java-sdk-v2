...
import com.aliyun.sdk.service.oss2.agentic.AsyncBucketSpaceClient;
...
public class BucketSpacePutObjectAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncClient client = AsyncBucketSpaceClient.create(configBuilder.build())) {
            // Object operations inside an existing bucket space need the space prefix only,
            // the client resolves it to "{bucket}-{accountId}-{region}-bs-apsr".
    ...
    public void runCmd(CommandLine cmd) throws ParseException {
        ...
        execute(endpoint, region, accountId, bucket, key);
    }
}
