...
public class PutAccessPointPolicy implements Example {
    ...
    private static void execute(
        ...
        try (OSSClient client = getDefaultClient(endpoint, region, provider)) {
            ...
            PutAccessPointPolicyResult result = client.putAccessPointPolicy(request);

            System.out.printf("Put access point policy success, request id: %s\n",
                    result.requestId());
