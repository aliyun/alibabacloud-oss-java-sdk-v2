...
public class SelectObjectAsyncJson implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncClient client = getDefaultAsyncClient(endpoint, region, provider)) {
            ...
            try (SelectObjectResult result = client.selectObjectAsync(SelectObjectRequest.newBuilder()
                ...
                BufferedReader reader = new BufferedReader(new InputStreamReader(result.body(), StandardCharsets.UTF_8));
                String line;
