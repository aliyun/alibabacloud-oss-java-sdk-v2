...
public final class GetSmartClusterRequest extends RequestModel {
    private final String bucket;

    private GetSmartClusterRequest(Builder builder) {
        super(builder);
    ...
    public static class Builder extends RequestModel.Builder<Builder> {
        ...
        private Builder(GetSmartClusterRequest request) {
            super(request);
        ...
        public GetSmartClusterRequest build() { return new GetSmartClusterRequest(this); }
    }
}
