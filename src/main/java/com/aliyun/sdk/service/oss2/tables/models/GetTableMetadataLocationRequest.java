...
public final class GetTableMetadataLocationRequest extends TableRequestModel {
    private final String tableBucketARN;
    private final String namespace;
    private final String name;

    private GetTableMetadataLocationRequest(Builder builder) {
        super(builder);
    ...
    public static class Builder extends TableRequestModel.Builder<Builder> {
        ...
        private Builder(GetTableMetadataLocationRequest from) {
            super(from);
        ...
        public GetTableMetadataLocationRequest build() {
            return new GetTableMetadataLocationRequest(this);
        }
    }
}
