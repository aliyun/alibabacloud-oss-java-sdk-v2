...
public final class GetTableEncryptionRequest extends TableRequestModel {
    private final String tableBucketARN;
    private final String namespace;
    private final String name;

    private GetTableEncryptionRequest(Builder builder) {
        super(builder);
    ...
    public static class Builder extends TableRequestModel.Builder<Builder> {
        ...
        private Builder(GetTableEncryptionRequest from) {
            super(from);
        ...
        public GetTableEncryptionRequest build() {
            return new GetTableEncryptionRequest(this);
        }
    }
}
