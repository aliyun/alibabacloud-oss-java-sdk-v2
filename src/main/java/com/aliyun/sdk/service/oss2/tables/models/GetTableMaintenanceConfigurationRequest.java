...
public final class GetTableMaintenanceConfigurationRequest extends TableRequestModel {
    private final String tableBucketARN;
    private final String namespace;
    private final String name;

    private GetTableMaintenanceConfigurationRequest(Builder builder) {
        super(builder);
    ...
    public static class Builder extends TableRequestModel.Builder<Builder> {
        ...
        private Builder(GetTableMaintenanceConfigurationRequest from) {
            super(from);
        ...
        public GetTableMaintenanceConfigurationRequest build() {
            return new GetTableMaintenanceConfigurationRequest(this);
        }
    }
}
