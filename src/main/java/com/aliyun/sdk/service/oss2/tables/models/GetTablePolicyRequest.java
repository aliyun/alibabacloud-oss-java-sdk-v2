...
public final class GetTablePolicyRequest extends TableRequestModel {
    private final String tableBucketARN;
    private final String namespace;
    private final String name;

    private GetTablePolicyRequest(Builder builder) {
        super(builder);
    ...
    public static class Builder extends TableRequestModel.Builder<Builder> {
        ...
        private Builder(GetTablePolicyRequest from) {
            super(from);
        ...
        public GetTablePolicyRequest build() {
            return new GetTablePolicyRequest(this);
        }
    }
}
