 ...
 */
public final class GetAccessPointForObjectProcessRequest extends RequestModel { 
    private final String bucket;

    private GetAccessPointForObjectProcessRequest(Builder builder) {
        super(builder);
    ...
    public static class Builder extends RequestModel.Builder<Builder> { 
        ...
        */
        ...
        public GetAccessPointForObjectProcessRequest build() {
            return new GetAccessPointForObjectProcessRequest(this);
        }
        ...
        private Builder(GetAccessPointForObjectProcessRequest request) {
            super(request);
