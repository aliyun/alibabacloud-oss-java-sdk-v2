 ...
 */
public final class DeleteAccessPointForObjectProcessRequest extends RequestModel { 
    private final String bucket;

    private DeleteAccessPointForObjectProcessRequest(Builder builder) {
        super(builder);
    ...
    public static class Builder extends RequestModel.Builder<Builder> { 
        ...
        */
        ...
        public DeleteAccessPointForObjectProcessRequest build() {
            return new DeleteAccessPointForObjectProcessRequest(this);
        }
        ...
        private Builder(DeleteAccessPointForObjectProcessRequest request) {
            super(request);
