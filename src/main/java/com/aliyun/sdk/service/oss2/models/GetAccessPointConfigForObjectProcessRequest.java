 ...
 */
public final class GetAccessPointConfigForObjectProcessRequest extends RequestModel { 
    private final String bucket;

    private GetAccessPointConfigForObjectProcessRequest(Builder builder) {
        super(builder);
    ...
    public static class Builder extends RequestModel.Builder<Builder> { 
        ...
        */
        ...
        public GetAccessPointConfigForObjectProcessRequest build() {
            return new GetAccessPointConfigForObjectProcessRequest(this);
        }
        ...
        private Builder(GetAccessPointConfigForObjectProcessRequest request) {
            super(request);
