...
public final class DeleteTablePolicyRequest extends TableRequestModel {
    private final String tableBucketARN;
    private final String namespace;
    private final String name;

    private DeleteTablePolicyRequest(Builder builder) {
        super(builder);
    ...
    public static class Builder extends TableRequestModel.Builder<Builder> {
        ...
        private Builder(DeleteTablePolicyRequest from) {
            super(from);
        ...
        public DeleteTablePolicyRequest build() {
            return new DeleteTablePolicyRequest(this);
        }
    }
}
