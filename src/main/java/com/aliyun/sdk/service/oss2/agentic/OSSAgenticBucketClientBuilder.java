...
/**
 * A builder for {@link OSSAgenticBucketClient}.
 *
 ...
 * enabled.
 */
public interface OSSAgenticBucketClientBuilder extends BaseClientBuilder<OSSAgenticBucketClientBuilder, OSSAgenticBucketClient> {
    /**
     * Uses Apache HttpClient 4 as the underlying HTTP transport instead of the default.
     *
     * @param value {@code true} to use Apache HttpClient 4.
     * @return This builder for method chaining.
     */
    OSSAgenticBucketClientBuilder useApacheHttpClient4(boolean value);
}
