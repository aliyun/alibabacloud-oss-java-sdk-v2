...
public final class DeleteTableBucketRequest extends TableRequestModel {
    private final String tableBucketARN;

    private DeleteTableBucketRequest(Builder builder) {
        super(builder);
    ...
    public static class Builder extends TableRequestModel.Builder<Builder> {
        ...
        private Builder(DeleteTableBucketRequest from) {
            super(from);
        ...
        public DeleteTableBucketRequest build() {
            return new DeleteTableBucketRequest(this);
        }
    }
}
