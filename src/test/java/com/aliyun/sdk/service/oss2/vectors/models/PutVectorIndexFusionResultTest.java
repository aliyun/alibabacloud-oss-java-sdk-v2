...
public class PutVectorIndexFusionResultTest {

    @Test
    public void testEmptyBuilder() {
        PutVectorIndexFusionResult result = PutVectorIndexFusionResult.newBuilder().build();
    ...
    public void testFullBuilder() {
        ...
        PutVectorIndexFusionResult result = PutVectorIndexFusionResult.newBuilder()
                .headers(headers)
                .status("OK")
                .statusCode(200)
                .build();
    ...
    public void testToBuilderPreserveState() {
        ...
        PutVectorIndexFusionResult original = PutVectorIndexFusionResult.newBuilder()
                .headers(headers)
                .status("Created")
                .statusCode(201)
                .build();

        PutVectorIndexFusionResult copy = original.toBuilder().build();
    ...
    public void xmlBuilder() {
        ...
        PutVectorIndexFusionResult result = SerdeVectorIndexBasic.toPutVectorIndexFusion(output);
