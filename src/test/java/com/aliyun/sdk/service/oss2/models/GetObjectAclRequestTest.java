...
public class GetObjectAclRequestTest {
    @Test
    public void testEmptyBuilder() {
        GetObjectAclRequest request = GetObjectAclRequest.newBuilder().build();
    ...
    public void testFullBuilder() {
        ...
        GetObjectAclRequest request = GetObjectAclRequest.newBuilder()
    ...
    public void testToBuilderPreserveState() {
        ...
        GetObjectAclRequest original = GetObjectAclRequest.newBuilder()
                .bucket("examplebucket")
                .key("exampleobject.txt")
                .headers(headers)
        ...
        GetObjectAclRequest copy = original.toBuilder().build();
