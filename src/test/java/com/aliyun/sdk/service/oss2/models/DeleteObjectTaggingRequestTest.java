...
public class DeleteObjectTaggingRequestTest {
    @Test
    public void testEmptyBuilder() {
        DeleteObjectTaggingRequest request = DeleteObjectTaggingRequest.newBuilder().build();
    ...
    public void testFullBuilder() {
        ...
        DeleteObjectTaggingRequest request = DeleteObjectTaggingRequest.newBuilder()
    ...
    public void testToBuilderPreserveState() {
        ...
        DeleteObjectTaggingRequest original = DeleteObjectTaggingRequest.newBuilder()
                .bucket("examplebucket")
                .key("exampleobject")
        ...
        DeleteObjectTaggingRequest copy = original.toBuilder().build();
