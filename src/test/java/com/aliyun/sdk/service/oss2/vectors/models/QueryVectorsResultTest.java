...
public class QueryVectorsResultTest {
    ...
    public void testFullBuilder() {
        ...
        queryVectorsJson.vectors = Arrays.asList(vector);
    ...
    public void testToBuilderPreserveState() {
        ...
        assertThat(copy.vectors()).isEqualTo(Arrays.asList(vector));
        assertThat(copy.status()).isEqualTo("Partial");
        assertThat(copy.statusCode()).isEqualTo(206);
        assertThat(copy.requestId()).isEqualTo("req-765432109876543210");

        // Test asVectors method
        QueryVectorsInfo vectorsInfo = copy.asVectors();
        assertThat(vectorsInfo).isNotNull();
        assertThat(vectorsInfo.vectors()).isNotNull();
        assertThat(vectorsInfo.vectors()).hasSize(1);
    ...
    public void xmlBuilder() {
        ...
        assertThat(vector).containsKey("distance");
        assertThat(vector.get("distance")).isEqualTo(1);
