...
public class DeleteBucketPolicyRequestTest {

    @Test
    public void testEmptyBuilder() {
        DeleteBucketPolicyRequest request = DeleteBucketPolicyRequest.newBuilder().build();
    ...
    public void testFullBuilder() {
        ...
        DeleteBucketPolicyRequest request = DeleteBucketPolicyRequest.newBuilder()
    ...
    public void testToBuilderPreserveState() {
        ...
        DeleteBucketPolicyRequest original = DeleteBucketPolicyRequest.newBuilder()
                .bucket("testbucket")
                .headers(headers)
        ...
        DeleteBucketPolicyRequest copy = original.toBuilder().build();
