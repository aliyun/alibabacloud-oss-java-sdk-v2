...
public class DeleteTableBucketEncryptionResultTest {

    @Test
    public void testEmptyBuilder() {
        DeleteTableBucketEncryptionResult result = DeleteTableBucketEncryptionResult.newBuilder().build();
    ...
    public void testFullBuilder() {
        ...
        DeleteTableBucketEncryptionResult result = DeleteTableBucketEncryptionResult.newBuilder()
                .headers(headers)
                .status("OK")
                .statusCode(200)
                .build();
    ...
    public void testToBuilderPreserveState() {
        ...
        DeleteTableBucketEncryptionResult original = DeleteTableBucketEncryptionResult.newBuilder()
                .headers(headers)
                .status("Created")
                .statusCode(204)
                .build();

        DeleteTableBucketEncryptionResult copy = original.toBuilder().build();
    ...
    public void xmlBuilder() {
        ...
        DeleteTableBucketEncryptionResult result = SerdeTableBucketConfigBasic.toDeleteTableBucketEncryption(output);
