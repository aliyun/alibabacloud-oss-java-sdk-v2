...
public class DeleteObjectRequestTest {
    ...
    public void testEmptyBuilder() {
        DeleteObjectRequest request = DeleteObjectRequest.newBuilder().build();
    ...
    public void testToBuilderPreserveState() {
        ...
        DeleteObjectRequest original = DeleteObjectRequest.newBuilder()
                .bucket("examplebucket")
                .key("exampleobject.txt")
                .headers(headers)
        ...
        DeleteObjectRequest copy = original.toBuilder().build();
