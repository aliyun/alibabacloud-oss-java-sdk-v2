...
public class GetBucketTagsRequestTest {
    @Test
    public void testEmptyBuilder() {
        GetBucketTagsRequest request = GetBucketTagsRequest.newBuilder().build();
    ...
    public void testFullBuilder() {
        ...
        GetBucketTagsRequest request = GetBucketTagsRequest.newBuilder()
    ...
    public void testToBuilderPreserveState() {
        ...
        GetBucketTagsRequest original = GetBucketTagsRequest.newBuilder()
                .bucket("testbucket")
                .headers(headers)
        ...
        GetBucketTagsRequest copy = original.toBuilder().build();
