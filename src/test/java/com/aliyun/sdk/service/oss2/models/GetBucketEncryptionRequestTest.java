...
public class GetBucketEncryptionRequestTest {

    @Test
    public void testEmptyBuilder() {
        GetBucketEncryptionRequest request = GetBucketEncryptionRequest.newBuilder().build();
    ...
    public void testFullBuilder() {
        ...
        GetBucketEncryptionRequest request = GetBucketEncryptionRequest.newBuilder()
    ...
    public void testToBuilderPreserveState() {
        ...
        GetBucketEncryptionRequest original = GetBucketEncryptionRequest.newBuilder()
                .bucket("testbucket")
                .headers(headers)
        ...
        GetBucketEncryptionRequest copy = original.toBuilder().build();
