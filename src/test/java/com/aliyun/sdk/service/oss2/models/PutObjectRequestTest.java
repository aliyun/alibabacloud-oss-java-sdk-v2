...
public class PutObjectRequestTest {
    ...
    public void testEmptyBuilder() {
        PutObjectRequest request = PutObjectRequest.newBuilder().build();
    ...
    public void testToBuilderPreserveState() {
        ...
        PutObjectRequest original = PutObjectRequest.newBuilder()
                .bucket("examplebucket")
                .key("exampleobject.txt")
                .body(body)
                .headers(headers)
        ...
        PutObjectRequest copy = original.toBuilder().build();
    ...
    public void testHeaderProperties() {
        ...
        assertThat(request.callback()).isEqualTo("callback-data");
        assertThat(request.callbackVar()).isEqualTo("var-data");
