...
public class PutVectorIndexResultTest {

    @Test
    public void testEmptyBuilder() {
        PutVectorIndexResult result = PutVectorIndexResult.newBuilder().build();
    ...
    public void testFullBuilder() {
        ...
        PutVectorIndexResult result = PutVectorIndexResult.newBuilder()
                .headers(headers)
                .status("OK")
                .statusCode(200)
                .build();
    ...
    public void testToBuilderPreserveState() {
        ...
        PutVectorIndexResult original = PutVectorIndexResult.newBuilder()
                .headers(headers)
                .status("Created")
                .statusCode(201)
                .build();

        PutVectorIndexResult copy = original.toBuilder().build();
    ...
    public void xmlBuilder() {
        ...
        PutVectorIndexResult result = SerdeVectorIndexBasic.toPutVectorIndex(output);
