...
public class DeleteBucketLoggingRequestTest {

    @Test
    public void testEmptyBuilder() {
        DeleteBucketLoggingRequest request = DeleteBucketLoggingRequest.newBuilder().build();
    ...
    public void testFullBuilder() {
        ...
        DeleteBucketLoggingRequest request = DeleteBucketLoggingRequest.newBuilder()
    ...
    public void testToBuilderPreserveState() {
        ...
        DeleteBucketLoggingRequest original = DeleteBucketLoggingRequest.newBuilder()
                .bucket("testbucket")
                .headers(headers)
        ...
        DeleteBucketLoggingRequest copy = original.toBuilder().build();
