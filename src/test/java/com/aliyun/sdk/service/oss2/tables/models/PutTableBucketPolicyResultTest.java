...
public class PutTableBucketPolicyResultTest {

    @Test
    public void testEmptyBuilder() {
        PutTableBucketPolicyResult result = PutTableBucketPolicyResult.newBuilder().build();
    ...
    public void testFullBuilder() {
        ...
        PutTableBucketPolicyResult result = PutTableBucketPolicyResult.newBuilder()
                .headers(headers)
                .status("OK")
                .statusCode(200)
                .build();
    ...
    public void testToBuilderPreserveState() {
        ...
        PutTableBucketPolicyResult original = PutTableBucketPolicyResult.newBuilder()
                .headers(headers)
                .status("Created")
                .statusCode(201)
                .build();

        PutTableBucketPolicyResult copy = original.toBuilder().build();
    ...
    public void xmlBuilder() {
        ...
        PutTableBucketPolicyResult result = SerdeTableBucketConfigBasic.toPutTableBucketPolicy(output);
