...
public class GetUserDefinedLogFieldsConfigResultTest {
    ...
    public void testToBuilderPreserveState() {
        ...
        HeaderSet headerSet = HeaderSet.newBuilder().headers(Arrays.asList("header1", "header2")).build();
        ParamSet paramSet = ParamSet.newBuilder().parameters(Arrays.asList("param1")).build();
