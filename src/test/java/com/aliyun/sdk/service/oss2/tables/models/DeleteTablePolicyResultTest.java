...
public class DeleteTablePolicyResultTest {

    @Test
    public void testEmptyBuilder() {
        DeleteTablePolicyResult result = DeleteTablePolicyResult.newBuilder().build();
    ...
    public void testFullBuilder() {
        ...
        DeleteTablePolicyResult result = DeleteTablePolicyResult.newBuilder()
                .headers(headers)
                .status("OK")
                .statusCode(200)
                .build();
    ...
    public void testToBuilderPreserveState() {
        ...
        DeleteTablePolicyResult original = DeleteTablePolicyResult.newBuilder()
                .headers(headers)
                .status("Created")
                .statusCode(201)
                .build();

        DeleteTablePolicyResult copy = original.toBuilder().build();
    ...
    public void xmlBuilder() {
        ...
        DeleteTablePolicyResult result = SerdeTableConfigBasic.toDeleteTablePolicy(output);
