...
public class ListCnameRequestTest {
    @Test
    public void testEmptyBuilder() {
        ListCnameRequest request = ListCnameRequest.newBuilder().build();
    ...
    public void testFullBuilder() {
        ...
        ListCnameRequest request = ListCnameRequest.newBuilder()
    ...
    public void testToBuilderPreserveState() {
        ...
        ListCnameRequest original = ListCnameRequest.newBuilder()
                .bucket("testbucket")
                .headers(headers)
        ...
        ListCnameRequest copy = original.toBuilder().build();
