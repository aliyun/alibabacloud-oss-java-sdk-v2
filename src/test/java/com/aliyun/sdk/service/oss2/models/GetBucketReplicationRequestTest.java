...
public class GetBucketReplicationRequestTest {

    @Test
    public void testEmptyBuilder() {
        GetBucketReplicationRequest request = GetBucketReplicationRequest.newBuilder().build();
    ...
    public void testFullBuilder() {
        ...
        GetBucketReplicationRequest request = GetBucketReplicationRequest.newBuilder()
    ...
    public void testToBuilderPreserveState() {
        ...
        GetBucketReplicationRequest original = GetBucketReplicationRequest.newBuilder()
                .bucket("testbucket")
                .headers(headers)
        ...
        GetBucketReplicationRequest copy = original.toBuilder().build();
