...
public class DeleteNamespaceResultTest {

    @Test
    public void testEmptyBuilder() {
        DeleteNamespaceResult result = DeleteNamespaceResult.newBuilder().build();
    ...
    public void testFullBuilder() {
        ...
        DeleteNamespaceResult result = DeleteNamespaceResult.newBuilder()
                .headers(headers)
                .status("OK")
                .statusCode(204)
                .build();
    ...
    public void testToBuilderPreserveState() {
        ...
        DeleteNamespaceResult original = DeleteNamespaceResult.newBuilder()
                .headers(headers)
                .status("No Content")
                .statusCode(204)
                .build();

        DeleteNamespaceResult copy = original.toBuilder().build();
    ...
    public void xmlBuilder() {
        ...
        DeleteNamespaceResult result = SerdeNamespaceBasic.toDeleteNamespace(output);
