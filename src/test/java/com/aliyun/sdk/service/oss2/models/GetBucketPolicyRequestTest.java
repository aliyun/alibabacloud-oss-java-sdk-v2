...
public class GetBucketPolicyRequestTest {

    @Test
    public void testEmptyBuilder() {
        GetBucketPolicyRequest request = GetBucketPolicyRequest.newBuilder().build();
    ...
    public void testFullBuilder() {
        ...
        GetBucketPolicyRequest request = GetBucketPolicyRequest.newBuilder()
    ...
    public void testToBuilderPreserveState() {
        ...
        GetBucketPolicyRequest original = GetBucketPolicyRequest.newBuilder()
                .bucket("testbucket")
                .headers(headers)
        ...
        GetBucketPolicyRequest copy = original.toBuilder().build();
