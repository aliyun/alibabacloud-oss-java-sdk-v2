...
public class DeleteTableBucketPolicyResultTest {

    @Test
    public void testEmptyBuilder() {
        DeleteTableBucketPolicyResult result = DeleteTableBucketPolicyResult.newBuilder().build();
    ...
    public void testFullBuilder() {
        ...
        DeleteTableBucketPolicyResult result = DeleteTableBucketPolicyResult.newBuilder()
                .headers(headers)
                .status("OK")
                .statusCode(200)
                .build();
    ...
    public void testToBuilderPreserveState() {
        ...
        DeleteTableBucketPolicyResult original = DeleteTableBucketPolicyResult.newBuilder()
                .headers(headers)
                .status("Created")
                .statusCode(201)
                .build();

        DeleteTableBucketPolicyResult copy = original.toBuilder().build();
    ...
    public void xmlBuilder() {
        ...
        DeleteTableBucketPolicyResult result = SerdeTableBucketConfigBasic.toDeleteTableBucketPolicy(output);
