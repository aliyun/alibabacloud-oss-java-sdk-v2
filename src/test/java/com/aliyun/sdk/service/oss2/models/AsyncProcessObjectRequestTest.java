...
public class AsyncProcessObjectRequestTest {

    @Test
    public void testEmptyBuilder() {
        AsyncProcessObjectRequest request = AsyncProcessObjectRequest.newBuilder().build();
    ...
    public void testToBuilderPreserveState() {
        ...
        AsyncProcessObjectRequest original = AsyncProcessObjectRequest.newBuilder()
                .bucket("testbucket")
                .key("test.jpg")
        ...
        AsyncProcessObjectRequest copy = original.toBuilder().build();
    ...
    public void xmlBuilder() {
        ...
        assertThat(input.parameters().get("x-oss-async-process")).isEqualTo("");
        assertThat(input.headers().get("Content-Type")).isEqualTo("application/xml");

        // Verify the body content
        String bodyContent = new String(input.body().get().toBytes());
        assertThat(bodyContent).isEqualTo("x-oss-async-process=image/resize,m_fixed,w_100,h_100|sys/saveas,o_amF2YS1zZGstdGVzdC1vYmplY3QtMTc1NjgwNDM4NS0xOTEtcHJvY2Vzc2VkLnBuZw==,b_amF2YS1zZGstdGVzdC1idWNrZXQtMTc1NjgwNDM3Ni03Mi00Mzkw");
    }
}
