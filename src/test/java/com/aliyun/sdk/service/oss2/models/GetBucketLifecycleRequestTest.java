...
public class GetBucketLifecycleRequestTest {
    ...
    public void testEmptyBuilder() {
        GetBucketLifecycleRequest request = GetBucketLifecycleRequest.newBuilder().build();
    ...
    public void testFullBuilder() {
        ...
        GetBucketLifecycleRequest request = GetBucketLifecycleRequest.newBuilder()
    ...
    public void testToBuilderPreserveState() {
        ...
        GetBucketLifecycleRequest original = GetBucketLifecycleRequest.newBuilder()
                .bucket("testbucket")
                .headers(headers)
        ...
        GetBucketLifecycleRequest copy = original.toBuilder().build();
