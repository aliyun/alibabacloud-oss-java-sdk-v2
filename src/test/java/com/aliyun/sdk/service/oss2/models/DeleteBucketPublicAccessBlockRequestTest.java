...
public class DeleteBucketPublicAccessBlockRequestTest {
    @Test
    public void testEmptyBuilder() {
        DeleteBucketPublicAccessBlockRequest request = DeleteBucketPublicAccessBlockRequest.newBuilder().build();
    ...
    public void testFullBuilder() {
        ...
        DeleteBucketPublicAccessBlockRequest request = DeleteBucketPublicAccessBlockRequest.newBuilder()
    ...
    public void testToBuilderPreserveState() {
        ...
        DeleteBucketPublicAccessBlockRequest original = DeleteBucketPublicAccessBlockRequest.newBuilder()
                .bucket("testbucket")
                .headers(headers)
        ...
        DeleteBucketPublicAccessBlockRequest copy = original.toBuilder().build();
