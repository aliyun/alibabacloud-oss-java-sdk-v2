...
public class PutBucketTransferAccelerationResultTest {

    @Test
    public void testEmptyBuilder() {
        PutBucketTransferAccelerationResult result = PutBucketTransferAccelerationResult.newBuilder().build();
    ...
    public void testFullBuilder() {
        ...
        PutBucketTransferAccelerationResult result = PutBucketTransferAccelerationResult.newBuilder()
                .headers(headers)
    ...
    public void testToBuilderPreserveState() {
        ...
        PutBucketTransferAccelerationResult original = PutBucketTransferAccelerationResult.newBuilder()
                .headers(headers)
                .status("HTTP/1.1 200 OK")
                .statusCode(200)
                .build();

        PutBucketTransferAccelerationResult copy = original.toBuilder().build();
