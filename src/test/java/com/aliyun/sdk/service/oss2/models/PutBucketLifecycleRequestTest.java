...
public class PutBucketLifecycleRequestTest {
    ...
    public void testFullBuilder() {
        ...
        List<LifecycleRule> rules = Arrays.asList(
                LifecycleRule.newBuilder()
                        ...
                        .prefix("logs1/")
                        .status("Enabled")
                        .expiration(Expiration.newBuilder()
                                .createdBeforeDate(Instant.parse("2020-06-22T11:42:32.000Z"))
                                .days(1)
                                .expiredObjectDeleteMarker(true)
                                .build())
                        .abortMultipartUpload(AbortMultipartUpload.newBuilder()
                                .days(30)
                                .build())
                        .build(),
                LifecycleRule.newBuilder()
    ...
    public void xmlBuilder() throws JsonProcessingException {
        ...
        assertThat(rule3.filter().filterNot()).hasSize(2);
        
        LifecycleRuleNot not1 = rule3.filter().filterNot().get(0);
        ...
        LifecycleRuleNot not2 = rule3.filter().filterNot().get(1);
