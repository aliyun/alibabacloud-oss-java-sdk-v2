...
public class ListPartsRequestTest {
    ...
    public void testEmptyBuilder() {
        ListPartsRequest request = ListPartsRequest.newBuilder().build();
        ...
        assertThat(request.maxParts()).isNull();
        assertThat(request.partNumberMarker()).isNull();
    ...
    public void testFullBuilder() {
        ...
        ListPartsRequest request = ListPartsRequest.newBuilder()
                .bucket("examplebucket")
                .key("examplekey")
                .uploadId("upload-id")
                .maxParts(100L)
                .partNumberMarker(10L)
                .encodingType("url")
        ...
        assertThat(request.maxParts()).isEqualTo(100L);
        assertThat(request.partNumberMarker()).isEqualTo(10L);
    ...
    public void testToBuilderPreserveState() {
        ...
        ListPartsRequest original = ListPartsRequest.newBuilder()
                .bucket("examplebucket")
                .key("examplekey")
        ...
        ListPartsRequest copy = original.toBuilder().build();

        assertThat(copy.bucket()).isEqualTo("examplebucket");
        assertThat(copy.key()).isEqualTo("examplekey");
        assertThat(copy.uploadId()).isEqualTo("upload-id-2");
        assertThat(copy.maxParts()).isEqualTo(50L);
        assertThat(copy.partNumberMarker()).isEqualTo(5L);
    ...
    public void testHeaderProperties() {
        ...
        assertThat(request.maxParts()).isEqualTo(25L);
        assertThat(request.partNumberMarker()).isEqualTo(2L);
        assertThat(request.encodingType()).isEqualTo("url");
        assertThat(request.requestPayer()).isEqualTo("requester");
    }
}
