...
public class GetSymlinkRequestTest {
    @Test
    public void testEmptyBuilder() {
        GetSymlinkRequest request = GetSymlinkRequest.newBuilder().build();
    ...
    public void testFullBuilder() {
        ...
        GetSymlinkRequest request = GetSymlinkRequest.newBuilder()
    ...
    public void testToBuilderPreserveState() {
        ...
        GetSymlinkRequest original = GetSymlinkRequest.newBuilder()
                .bucket("examplebucket")
                .key("examplesymlink")
        ...
        GetSymlinkRequest copy = original.toBuilder().build();
