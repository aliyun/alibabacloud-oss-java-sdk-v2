...
public class GetBucketLifecycleResultTest {
    ...
    public void testXmlBuilder() {
        ...
        // Check expiration
        LifecycleRuleExpiration expiration = rule1.expiration();
        ...
        LifecycleRuleAbortMultipartUpload abortMultipartUpload = rule1.abortMultipartUpload();
        ...
        // Check transitions
        List<LifecycleRuleTransition> transitions = rule2.transitions();
        assertThat(transitions).hasSize(2);

        LifecycleRuleTransition transition1 = transitions.get(0);
        ...
        LifecycleRuleTransition transition2 = transitions.get(1);
        ...
        List<LifecycleRuleNot> notList = filter.nots();
    ...
    private LifecycleConfiguration createLifecycleConfiguration() {
        // Create expiration
        LifecycleRuleExpiration expiration = LifecycleRuleExpiration.newBuilder()
        ...
        LifecycleRuleAbortMultipartUpload abortMultipartUpload = LifecycleRuleAbortMultipartUpload.newBuilder()
                .days(30)
                .build();

        // Create transitions
        List<LifecycleRuleTransition> transitions = Arrays.asList(
