...
public class CloseMetaQueryResultTest {
    ...
    public void xmlBuilder() {
        ...
        OperationOutput blankOutput = OperationOutput.newBuilder()
                ...
                .build();
        CloseMetaQueryResult closeResult = SerdeBucketMetaquery.toCloseMetaQuery(blankOutput);
        ...
        CloseMetaQueryResult result = SerdeBucketMetaquery.toCloseMetaQuery(output);
