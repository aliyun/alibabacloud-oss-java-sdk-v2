...
public class PutBucketVersioningResultTest {

    @Test
    public void testEmptyBuilder() {
        PutBucketVersioningResult result = PutBucketVersioningResult.newBuilder().build();
    ...
    public void testFullBuilder() {
        ...
        PutBucketVersioningResult result = PutBucketVersioningResult.newBuilder()
                .headers(headers)
    ...
    public void testToBuilderPreserveState() {
        ...
        PutBucketVersioningResult original = PutBucketVersioningResult.newBuilder()
                .headers(headers)
                .status("HTTP/1.1 200 OK")
                .statusCode(200)
                .build();
