...
public class GetBucketResourceGroupRequestTest {
    @Test
    public void testEmptyBuilder() {
        GetBucketResourceGroupRequest request = GetBucketResourceGroupRequest.newBuilder().build();
    ...
    public void testFullBuilder() {
        ...
        GetBucketResourceGroupRequest request = GetBucketResourceGroupRequest.newBuilder()
    ...
    public void testToBuilderPreserveState() {
        ...
        GetBucketResourceGroupRequest original = GetBucketResourceGroupRequest.newBuilder()
                .bucket("testbucket")
                .headers(headers)
        ...
        GetBucketResourceGroupRequest copy = original.toBuilder().build();
