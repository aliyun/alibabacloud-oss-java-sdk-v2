...
public class DeleteBucketOverwriteConfigRequestTest {

    @Test
    public void testEmptyBuilder() {
        DeleteBucketOverwriteConfigRequest request = DeleteBucketOverwriteConfigRequest.newBuilder().build();
    ...
    public void testFullBuilder() {
        ...
        DeleteBucketOverwriteConfigRequest request = DeleteBucketOverwriteConfigRequest.newBuilder()
    ...
    public void testToBuilderPreserveState() {
        ...
        DeleteBucketOverwriteConfigRequest original = DeleteBucketOverwriteConfigRequest.newBuilder()
                .bucket("testbucket")
                .headers(headers)
        ...
        DeleteBucketOverwriteConfigRequest copy = original.toBuilder().build();
