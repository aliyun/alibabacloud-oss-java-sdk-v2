...
public class RenameTableResultTest {

    @Test
    public void testEmptyBuilder() {
        RenameTableResult result = RenameTableResult.newBuilder().build();
    ...
    public void testFullBuilder() {
        ...
        RenameTableResult result = RenameTableResult.newBuilder()
                .headers(headers)
                .status("OK")
                .statusCode(200)
                .build();
    ...
    public void testToBuilderPreserveState() {
        ...
        RenameTableResult original = RenameTableResult.newBuilder()
                .headers(headers)
                .status("OK")
                .statusCode(200)
                .build();

        RenameTableResult copy = original.toBuilder().build();
    ...
    public void xmlBuilder() {
        ...
        RenameTableResult result = SerdeTableBasic.toRenameTable(output);
