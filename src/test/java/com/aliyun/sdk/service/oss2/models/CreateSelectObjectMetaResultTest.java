...
public class CreateSelectObjectMetaResultTest {
    ...
    public void testEmptyBuilder() {
        ...
        assertThat(result.selectObjectMeta()).isNull();
    }
    ...
    public void testCsvCreateSelectObjectMetaResult() throws IOException {
        ...
        assertThat(result.selectObjectMeta().totalScanned()).isEqualTo(0L);
        assertThat(result.selectObjectMeta().status()).isEqualTo(200L);
        assertThat(result.selectObjectMeta().splitsCount()).isEqualTo(0L);
        assertThat(result.selectObjectMeta().rowsCount()).isEqualTo(0L);
        assertThat(result.selectObjectMeta().columnsCount()).isEqualTo(0L);
        assertThat(result.selectObjectMeta().errorMessage()).isEqualTo(csvContent);
    }
    ...
    public void testJsonCreateSelectObjectMetaResult() throws IOException {
        ...
        assertThat(result.selectObjectMeta().errorMessage()).isEqualTo(jsonContent);
    }
}
