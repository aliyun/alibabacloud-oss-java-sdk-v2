...
public class GetBucketPublicAccessBlockRequestTest {
    @Test
    public void testEmptyBuilder() {
        GetBucketPublicAccessBlockRequest request = GetBucketPublicAccessBlockRequest.newBuilder().build();
    ...
    public void testFullBuilder() {
        ...
        GetBucketPublicAccessBlockRequest request = GetBucketPublicAccessBlockRequest.newBuilder()
    ...
    public void testToBuilderPreserveState() {
        ...
        GetBucketPublicAccessBlockRequest original = GetBucketPublicAccessBlockRequest.newBuilder()
                .bucket("testbucket")
                .headers(headers)
        ...
        GetBucketPublicAccessBlockRequest copy = original.toBuilder().build();
