...
public class PutTablePolicyResultTest {

    @Test
    public void testEmptyBuilder() {
        PutTablePolicyResult result = PutTablePolicyResult.newBuilder().build();
    ...
    public void testFullBuilder() {
        ...
        PutTablePolicyResult result = PutTablePolicyResult.newBuilder()
                .headers(headers)
                .status("OK")
                .statusCode(200)
                .build();
    ...
    public void testToBuilderPreserveState() {
        ...
        PutTablePolicyResult original = PutTablePolicyResult.newBuilder()
                .headers(headers)
                .status("Created")
                .statusCode(201)
                .build();

        PutTablePolicyResult copy = original.toBuilder().build();
    ...
    public void xmlBuilder() {
        ...
        PutTablePolicyResult result = SerdeTableConfigBasic.toPutTablePolicy(output);
