...
public class GetNamespaceRequestTest {
    ...
    public void testEmptyBuilder() {
        GetNamespaceRequest request = GetNamespaceRequest.newBuilder().build();
    ...
    public void testToBuilderPreserveState() {
        GetNamespaceRequest original = GetNamespaceRequest.newBuilder()
        ...
        GetNamespaceRequest copy = original.toBuilder().build();
