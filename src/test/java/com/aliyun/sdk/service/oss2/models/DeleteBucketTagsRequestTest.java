...
public class DeleteBucketTagsRequestTest {
    @Test
    public void testEmptyBuilder() {
        DeleteBucketTagsRequest request = DeleteBucketTagsRequest.newBuilder().build();
    ...
    public void testFullBuilder() {
        ...
        DeleteBucketTagsRequest request = DeleteBucketTagsRequest.newBuilder()
    ...
    public void testToBuilderPreserveState() {
        ...
        DeleteBucketTagsRequest original = DeleteBucketTagsRequest.newBuilder()
                .bucket("testbucket")
                .headers(headers)
        ...
        DeleteBucketTagsRequest copy = original.toBuilder().build();
