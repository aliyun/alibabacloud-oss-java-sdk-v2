...
public class OpenMetaQueryResultTest {
    ...
    public void xmlBuilder() {
        ...
        OperationOutput blankOutput = OperationOutput.newBuilder()
                ...
                .build();
        OpenMetaQueryResult openResult = SerdeBucketMetaquery.toOpenMetaQuery(blankOutput);
        assertThat(openResult).isNotNull();
        ...
        OpenMetaQueryResult result = SerdeBucketMetaquery.toOpenMetaQuery(output);
