...
public class ClientAgenticBucketBasicTest extends TestBaseAgentic {
    ...
    @Test
    public void testAgenticBucketInvalidCredentials() throws Exception {
        try (OSSAgenticBucketClient client = newInvalidAkAgenticClient()) {
     ...
     */
    @Test
    public void testAgenticBucketPathStyle() throws Exception {
