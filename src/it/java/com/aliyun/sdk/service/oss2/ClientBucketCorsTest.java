...
public class ClientBucketCorsTest extends TestBase {

    @Test
    public void testBucketCORS_default() throws Exception {
        ...
        try (OSSClient client = getOssClient()) {
            ...
            PutBucketCorsResult putResult = client.putBucketCors(PutBucketCorsRequest.newBuilder()
                    .bucket(bucketName)
            ...
            // getBucketCors
            GetBucketCorsResult updatedResult = client.getBucketCors(GetBucketCorsRequest.newBuilder()
                    .bucket(bucketName)
                    .build());
            ...
            // deleteBucketCors
            DeleteBucketCorsResult deleteResult = client.deleteBucketCors(DeleteBucketCorsRequest.newBuilder()
                    .bucket(bucketName)
                    .build());
