...
public class ClientDeleteMultipleObjectsTest extends TestBase {
    ...
    public void testDeleteMultipleObjectsBasic() {
        ...
        PutObjectResult putResult3 = client.putObject(PutObjectRequest.newBuilder()
                .bucket(bucketName)
                .key(objectName3)
    ...
    @Test
    public void testDeleteMultipleObjectsWithNonExistentObject() {
        OSSClient client = getDefaultClient();
    ...
    @Test
    public void testDeleteMultipleObjectsQuietMode() {
        OSSClient client = getDefaultClient();
    ...
    @Test
    public void testDeleteMultipleObjectsWithSpecialCharacters() {
        OSSClient client = getDefaultClient();
        ...
        PutObjectResult putResult4 = client.putObject(PutObjectRequest.newBuilder()
                .bucket(bucketName)
                .key(specialKey4)
                .body(new ByteArrayBinaryData("content3".getBytes(StandardCharsets.UTF_8)))
                .build());
        ...
        HeadObjectResult headResult4 = client.headObject(HeadObjectRequest.newBuilder()
                .bucket(bucketName)
                .key(specialKey4)
                .build());
    ...
    @Test
    public void testDeleteMultipleObjectsWithNewDeleteAPI() {
        OSSClient client = getDefaultClient();
        ...
        Delete delete = Delete.newBuilder()
                .quiet(false)
                .objects(Arrays.asList(identifier1, identifier2))
                .build();
