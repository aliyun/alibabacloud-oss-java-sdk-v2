...
public class ClientObjectAsyncTest extends TestBase {

    @Test
    public void testObjectOperations() throws ExecutionException, InterruptedException {
        ...
        // get object meta
        GetObjectMetaResult metaResult = client.getObjectMetaAsync(GetObjectMetaRequest.newBuilder()
                .bucket(bucketName)
                .key(objectName)
                .build()).get();
        ...
        DeleteObjectResult deleteAppendResult = client.deleteObjectAsync(DeleteObjectRequest.newBuilder()
                .bucket(bucketName)
                .key(appendObjectName)
                .build()).get();
        ...
        // restore object
        RestoreObjectResult restoreResult = client.restoreObjectAsync(RestoreObjectRequest.newBuilder()
                .bucket(bucketName)
                .key(coldObjectName)
                .build()).get();
        ...
        try {
            CleanRestoredObjectResult cleanResult = client.cleanRestoredObjectAsync(CleanRestoredObjectRequest.newBuilder()
                    .bucket(bucketName)
                    .key(coldObjectName)
                    .build()).get();
    ...
    public void testGetObject_abortBody() throws Exception {
        ...
        try (GetObjectResult getResult = client.getObjectAsync(GetObjectRequest.newBuilder()
            ...
            // take no effect to async operation
            getResult.abort();
            assertThat(IOUtils.toByteArray(getResult.body())).isEqualTo(content);
        }
    }
    ...
    public void testUploadObject_addContentType() throws Exception {
        ...
        AppendObjectResult appendResult = client.appendObjectAsync(AppendObjectRequest.newBuilder()
                .bucket(bucketName)
                .key(objectName)
                .position(0L)
    ...
    @Test
    public void testObjectOperations_withProgress() throws ExecutionException, InterruptedException {
    ...
    public void testObjectOperations_enableCrc() throws Exception {
        ...
        try {
            client.appendObjectAsync(AppendObjectRequest.newBuilder()
                    .bucket(bucketName)
                    .key(appendObjectName)
                    .body(BinaryData.fromString("hello world"))
