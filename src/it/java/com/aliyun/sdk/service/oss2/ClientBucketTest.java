...
public class ClientBucketTest extends TestBase {
    ...
    public void testBucketOperations() {
        ...
        // put bucket
        PutBucketResult putResult = client.putBucket(PutBucketRequest.newBuilder()
        ...
        // list objects
        ListObjectsResult listResult = client.listObjects(ListObjectsRequest.newBuilder()
                .bucket(newBucketName)
                .prefix("oss")
                .build());
        ...
        // list objects v2
        ListObjectsV2Result listV2Result = client.listObjectsV2(ListObjectsV2Request.newBuilder()
                .bucket(newBucketName)
                .prefix("java")
                .build());
        ...
        // get bucket info
        GetBucketInfoResult infoResult = client.getBucketInfo(GetBucketInfoRequest.newBuilder()
                .bucket(newBucketName)
                .build());
        ...
        // get bucket location
        GetBucketLocationResult locationResult = client.getBucketLocation(GetBucketLocationRequest.newBuilder()
                .bucket(newBucketName)
                .build());
        Assert.assertEquals(200, infoResult.statusCode());
        ...
        // get bucket stat
        GetBucketStatResult statResult = client.getBucketStat(GetBucketStatRequest.newBuilder()
                .bucket(newBucketName)
                .build());
        ...
        // delete bucket
        DeleteBucketResult deleteResult = client.deleteBucket(DeleteBucketRequest.newBuilder()
                .bucket(newBucketName)
                .build());
    ...
    @Test
    public void testListObjectsWithAllSpecialCharacters() {
        OSSClient client = getDefaultClient();
        String newBucketName = genBucketName();
        ...
        ListObjectsResult listResultWithMaxKeys = client.listObjects(ListObjectsRequest.newBuilder()
                .bucket(newBucketName)
                .maxKeys(1L)
                .encodingType("url")
                .build());
    ...
    @Test
    public void testListObjectsV2WithAllSpecialCharacters() {
        OSSClient client = getDefaultClient();
        String newBucketName = genBucketName();
        ...
        ListObjectsV2Result listV2ResultWithMaxKeys = client.listObjectsV2(ListObjectsV2Request.newBuilder()
                .bucket(newBucketName)
                .maxKeys(1L)
                .encodingType("url")
                .build());
        ...
        ListObjectsV2Result firstResult = client.listObjectsV2(ListObjectsV2Request.newBuilder()
                .bucket(newBucketName)
                .maxKeys(2L)
                .encodingType("url")
                .build());
        ...
        if (firstResult.isTruncated() && firstResult.nextContinuationToken() != null) {
            ...
            ListObjectsV2Result secondResult = client.listObjectsV2(ListObjectsV2Request.newBuilder()
                    .bucket(newBucketName)
