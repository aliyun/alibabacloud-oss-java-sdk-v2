...
public class ClientBucketOverwriteConfigAsyncTest extends TestBase {
    ...
    public void testBucketOverwriteConfig_default() throws Exception {
        ...
        PutBucketOverwriteConfigResult putResult = client.putBucketOverwriteConfigAsync(putRequest).get();
        ...
        GetBucketOverwriteConfigResult getResult = client.getBucketOverwriteConfigAsync(getRequest).get();
        ...
        DeleteBucketOverwriteConfigRequest deleteRequest = DeleteBucketOverwriteConfigRequest.newBuilder()
                .bucket(bucketName)
                .build();
        DeleteBucketOverwriteConfigResult deleteResult = client.deleteBucketOverwriteConfigAsync(deleteRequest).get();
