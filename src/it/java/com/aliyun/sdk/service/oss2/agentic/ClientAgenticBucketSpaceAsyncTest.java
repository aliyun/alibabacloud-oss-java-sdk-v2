...
public class ClientAgenticBucketSpaceAsyncTest extends TestBaseAgentic {
     ...
     */
    @Test
    public void testBucketSpaceLifecycleAsync() throws Exception {
        ...
        try {
            ...
            try (OSSAsyncAgenticBucketClient asyncAgenticClient = newAgenticAsyncClient()) {
     ...
     */
    @Test
    public void testBucketSpaceClientIndependentAsync() throws Exception {
        String bsPrefix = genBucketSpaceName();
     ...
     */
    @Test
    public void testBucketSpaceObjectOperationsPathStyleAsync() throws Exception {
        String bsPrefix = genBucketSpaceName();
        String bsFullName = buildFullName(bsPrefix, BUCKET_SPACE_SUFFIX);
        String bsFullAgenticBucket = getFullAgenticBucketName();
        ...
        try {
            ...
            try (OSSAsyncClient pathAsyncClient = OSSAsyncClient.newBuilder()
                    .region(region())
                    .endpoint(endpoint())
