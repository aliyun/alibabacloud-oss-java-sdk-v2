...
public class ClientSelectObjectAsyncTest extends TestBase {
    ...
    @Test
    public void testCSVSelectObjectAsyncWithDataConsumerSupplier() throws Exception {
        OSSAsyncClient client = getDefaultAsyncClient();
        String objectName = genObjectName() + ".csv";
        ...
        BinaryDataConsumerSupplier supplier = new BinaryDataConsumerSupplier() {
            @Override
            public Object get() {
                return Channels.newChannel(userOut);
            }
        ...
        SelectObjectResult result = client.selectObjectAsync(SelectObjectRequest.newBuilder()
                .bucket(bucketName)
                .key(objectName)
                .selectRequest(selectRequest)
                .dataConsumerSupplier(supplier)
                .process("csv/select")
                .build()).get();
