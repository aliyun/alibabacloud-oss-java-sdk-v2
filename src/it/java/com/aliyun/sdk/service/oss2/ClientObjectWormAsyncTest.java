...
public class ClientObjectWormAsyncTest extends TestBase {
    ...
    private void deleteAllObjectsAsync(OSSAsyncClient client, String bucketName) throws Exception {
        ...
        try {
            ...
            ListObjectVersionsRequest listRequest = ListObjectVersionsRequest.newBuilder()
                    .bucket(bucketName)
                    .build();
            ListObjectVersionsResult listResult = client.listObjectVersionsAsync(listRequest).get();
                ...
                if (!objectsToDelete.isEmpty()) {
                    DeleteMultipleObjectsRequest deleteRequest = DeleteMultipleObjectsRequest.newBuilder()
                            ...
                            .delete(Delete.newBuilder()
                                    ...
                                    .build())
                            .build();
                    client.deleteMultipleObjectsAsync(deleteRequest).get();
            ...
            // Delete the bucket
            try {
                DeleteBucketResult result = client.deleteBucketAsync(DeleteBucketRequest.newBuilder()
                        .bucket(bucketName)
                        .build()).get();
    ...
    @Test
    public void testObjectRetentionAsync() throws Exception {
        OSSAsyncClient client = getDefaultAsyncClient();
        String bucketName = genObjectName();
        String objectKey = "test-retention-object-async";

        // Create bucket
        PutBucketResult result = client.putBucketAsync(PutBucketRequest.newBuilder()
                .bucket(bucketName)
                .acl("private")
        ...
        PutBucketObjectWormConfigurationResult wormConfigResult = client.putBucketObjectWormConfigurationAsync(PutBucketObjectWormConfigurationRequest.newBuilder()
                .bucket(bucketName)
        ...
        PutObjectRetentionResult retentionResult = client.putObjectRetentionAsync(PutObjectRetentionRequest.newBuilder()
                .bucket(bucketName)
                .key(objectKey)
        ...
        GetObjectRetentionResult getResult = client.getObjectRetentionAsync(GetObjectRetentionRequest.newBuilder()
                .bucket(bucketName)
                .key(objectKey)
                .build()).get();
        ...
        deleteAllObjectsAsync(client, bucketName);
    }

    @Test
    public void testObjectRetentionWithBypassAsync() throws Exception {
        OSSAsyncClient client = getDefaultAsyncClient();
        String bucketName = genObjectName();
        String objectKey = "test-retention-bypass-async";
    ...
    @Test
    public void testObjectLegalHoldAsyncOperations() throws Exception {
        OSSAsyncClient client = getDefaultAsyncClient();
        String objectName = genObjectName() + "-legalhold-async-test";
        ...
        PutBucketObjectWormConfigurationResult wormConfigResult = client.putBucketObjectWormConfigurationAsync(
        ...
        PutObjectLegalHoldResult putLegalHoldResult = client.putObjectLegalHoldAsync(
        ...
        GetObjectLegalHoldResult getLegalHoldResult = client.getObjectLegalHoldAsync(
        ...
        putLegalHoldResult = client.putObjectLegalHoldAsync(
                PutObjectLegalHoldRequest.newBuilder()
                        .bucket(bucketName)
                        .key(objectName)
        ...
        getLegalHoldResult = client.getObjectLegalHoldAsync(
                GetObjectLegalHoldRequest.newBuilder()
                        .bucket(bucketName)
                        .key(objectName)
                        .build()).get();
