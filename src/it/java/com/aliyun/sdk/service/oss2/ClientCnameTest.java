...
public class ClientCnameTest extends TestBase {

    @Test
    public void testCnameOperations() {
        ...
        try {
            PutCnameResult putResult = client.putCname(putRequest);
        ...
        ListCnameResult listResult = client.listCname(listRequest);
        ...
        DeleteCnameResult deleteResult = client.deleteCname(deleteRequest);
    ...
    @Test
    public void testCnameTokenOperations() {
        OSSClient client = getDefaultClient();
        String domain = "example.com";
        ...
        CreateCnameTokenResult createResult = client.createCnameToken(createRequest);
        ...
        GetCnameTokenResult getResult = client.getCnameToken(getRequest);
