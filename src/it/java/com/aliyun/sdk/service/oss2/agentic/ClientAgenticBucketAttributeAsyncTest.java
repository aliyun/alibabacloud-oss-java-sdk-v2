...
public class ClientAgenticBucketAttributeAsyncTest extends TestBaseAgentic {
    ...
    @Test
    public void testAgenticBucketAclAsync() throws Exception {
    ...
    @Test
    public void testAgenticBucketEncryptionAsync() throws Exception {
        try (OSSAsyncAgenticBucketClient client = newAgenticAsyncClient()) {
            String bucket = agenticBucketName;
    ...
    @Test
    public void testAgenticBucketVersioningAsync() throws Exception {
        try (OSSAsyncAgenticBucketClient client = newAgenticAsyncClient()) {
            String bucket = agenticBucketName;
    ...
    @Test
    public void testAgenticBucketPolicyAsync() throws Exception {
        try (OSSAsyncAgenticBucketClient client = newAgenticAsyncClient()) {
            String bucket = agenticBucketName;
    ...
    @Test
    public void testAgenticBucketPublicAccessBlockAsync() throws Exception {
        try (OSSAsyncAgenticBucketClient client = newAgenticAsyncClient()) {
            String bucket = agenticBucketName;
     ...
     */
    @Test
    public void testAgenticBucketAclPathStyleAsync() throws Exception {
