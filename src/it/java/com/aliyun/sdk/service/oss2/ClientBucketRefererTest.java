...
public class ClientBucketRefererTest extends TestBase {

    @Test
    public void testBucketReferer_default() throws Exception {
        ...
        try (OSSClient client = getOssClient()) {
            ...
            PutBucketRefererResult putResult = client.putBucketReferer(putRequest);
            ...
            GetBucketRefererResult getResult = client.getBucketReferer(getRequest);
