...
public class ClientAsyncProcessObjectTest extends TestBase {

    @Test
    public void testAsyncProcessObject() throws Exception {
        ...
        try {
            ...
            AsyncProcessObjectResult processResult = client.asyncProcessObject(AsyncProcessObjectRequest.newBuilder()
                    .bucket(bucketName)
                    .key(objectName)
                    .process(process)
                    .build());
