...
public class ClientBucketAccessMonitorAsyncTest extends TestBase {

    @Test
    public void testBucketAccessMonitorOperations() throws ExecutionException, InterruptedException {
        ...
        try {
            ...
            PutBucketAccessMonitorResult putResult1 = client.putBucketAccessMonitorAsync(
            ...
            GetBucketAccessMonitorResult getResult1 = client.getBucketAccessMonitorAsync(
            ...
            PutBucketAccessMonitorResult putResult2 = client.putBucketAccessMonitorAsync(
                    PutBucketAccessMonitorRequest.newBuilder()
                            .bucket(testBucketName)
            ...
            GetBucketAccessMonitorResult getResult2 = client.getBucketAccessMonitorAsync(
                    GetBucketAccessMonitorRequest.newBuilder()
                            .bucket(testBucketName)
                            .build()).get();
            ...
            PutBucketAccessMonitorResult putResult3 = client.putBucketAccessMonitorAsync(
                    PutBucketAccessMonitorRequest.newBuilder()
                            .bucket(testBucketName)
            ...
            GetBucketAccessMonitorResult getResult3 = client.getBucketAccessMonitorAsync(
                    GetBucketAccessMonitorRequest.newBuilder()
                            .bucket(testBucketName)
                            .build()).get();
